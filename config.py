...
# Set a custom expiratio Example: 24 hours = 86400, 12 hours = 43200
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/Tutorial01Ask/16")
...
UPI_ID = os.environ.get("UPI_ID", "Rajeshtg18x@ibl")
